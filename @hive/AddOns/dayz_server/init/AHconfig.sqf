...
/*  SUPER ADMIN HERE      */ _SAdmins = ["76561197960475835","76561198046457653","76561198087015545","0"]; //do not have a , at the end.
/*  BANNED PLAYER HERE    */ _BLOCKED = ["0","0","0"]; //do not have a , at the end.
/* ********************************************************************************* */
/*  Top esc menu TXT      */ _TopOfESC = "The Remaining"; //do not use " in this text.
/*  Bottom esc menu TXT   */ _LowerTop = "Vigilant Addiction"; //do not use " in this text.
/*  Bottom esc menu TXT2  */ _LowerBottom = "Season 1"; //do not use " in this text.
/*  Color esc menu TXT    */ _EscColor = [0.6,0,0,1];
/*  DebugMonitor TXT      */ _BottomDebug = "Season 1"; //do not use " in this text.
...
/*  ALLOWED Dialogs       */ _ALLOWED_Dialogs = [-1,106,2200,6900,6901,6902,6903,420420,41144,711194,55510];
...
[
	...
	"BTC_Hud","PlotManagement",'#USER:newspawn','#USER:classes','#USER:Page4','#USER:Donator','#USER:Peasant'
];
/* ********************************************************************************* */
