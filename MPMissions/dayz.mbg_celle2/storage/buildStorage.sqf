...
_config = missionConfigFile >> "CfgMagazines" >> _item;
...
if (!_isOk) then {
    ...
    sleep 5;
    //place tent (local)
    _tent = createVehicle ["StorageShed_DZ", _location, [], 0, "CAN_COLLIDE"];
    ...
    //["dayzPublishObj",[dayz_characterID,_tent,[_dir,_location],"StorageShed_DZ"]] call callRpcProcedure;
    dayzPublishObj = [dayz_characterID,_tent,[_dir,_location],"StorageShed_DZ"];
