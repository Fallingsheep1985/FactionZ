...
if (!isDedicated) then {
	...
	building_spawnLoot =		compile preprocessFileLineNumbers "CustomLoot\building_spawnLoot.sqf";
	building_spawnZombies =		compile preprocessFileLineNumbers "CustomLoot\building_spawnZombies.sqf";
	...
	player_updateGui =			compile preprocessFileLineNumbers "sheep\player_updateGui.sqf";
	...
	player_death =				compile preprocessFileLineNumbers "sheep\player_death.sqf";
	player_switchModel =		compile preprocessFileLineNumbers "sheep\player_switchModel.sqf";
	...
	zombie_generate = 			compile preprocessFileLineNumbers "CustomLoot\zombie_generate.sqf";			//Server compile, used for loiter behaviour
	...
	// Vehicle damage fix
	vehicle_handleDamage    = compile preprocessFileLineNumbers "sheep\vehicle_handleDamage.sqf";
	...
	//New storage
	player_storagePitch =		compile preprocessFileLineNumbers "storage\buildStorage.sqf";
	...
	//ui
	player_selectSlot =			compile preprocessFileLineNumbers "sheep\ui_selectSlot.sqf";
	...
	//System
	player_monitor =			compile preprocessFileLineNumbers "player_monitor.sqf";
	...
	//Both
	BIS_fnc_selectRandom =		compile preprocessFileLineNumbers "sheep\fn_selectRandom.sqf";		//Checks which actions for nearby casualty
	fnc_buildWeightedArray = 	compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_buildWeightedArray.sqf";		//Checks which actions for nearby casualty
	fnc_usec_damageVehicle =	compile preprocessFileLineNumbers "sheep\fn_damageHandlerVehicle.sqf";		//Event handler run on damage
	...
	local_eventKill = 			compile preprocessFileLineNumbers "sheep\local_eventKill.sqf";		//Generated when something is killed
