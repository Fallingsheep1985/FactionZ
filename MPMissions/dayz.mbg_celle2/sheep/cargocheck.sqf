...
[format[localize "str_actions_medical_15",_text],
cutText [format[("Magazines %1 / %2 | Weapons %3 / %4 | Backpacks %5 / %6"),_magazineCount,_maxMagazines,_weaponsCount,_maxWeapons,_backpackCount,_maxBackpacks], "PLAIN DOWN"];
