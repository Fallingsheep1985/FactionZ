...
// military AI
SAR_leader_sold_list = ["Soldier1_DZC"]; // the potential classes of the leader of a soldier group
SAR_sniper_sold_list = ["Sniper1_DZC"]; // the potential classes of the snipers of a soldier group
SAR_soldier_sold_list = ["Soldier1_DZC","Soldier3_DZC"]; // the potential classes of the riflemen of a soldier group

// bandit AI
SAR_leader_band_list = ["Soldier1_DZC"]; // the potential classes of the leader of a bandit group
SAR_sniper_band_list = ["Sniper1_DZC"]; // the potential classes of the snipers of a bandit group
SAR_soldier_band_list = ["Soldier2_DZC", "Soldier3_DZC","Soldier1_SF_DZC"]; // the potential classes of the riflemen of a bandit group

// survivor AI
SAR_leader_surv_list = ["Soldier1_DZC"]; // the potential classes of the leaders of a survivor group
SAR_sniper_surv_list = ["Sniper1_DZC"]; // the potential classes of the snipers of a survivor group
SAR_soldier_surv_list = ["Soldier2_DZC","Soldier3_DZC","Soldier1_SF_DZC"]; // the potential classes of the riflemen of a survivor group
...
// potential weapon list for leaders
SAR_surv_leader_weapon_list = ["M1014","M16A2","Winchester1866","LeeEnfield"];
...
//potential weapon list for riflemen
SAR_surv_rifleman_weapon_list = ["M16A2","Winchester1866","LeeEnfield","M1014"];
...
// potential item list for snipers
SAR_surv_sniper_items = [["ItemSodaCoke",75],["FoodCanBakedBeans",60],["Sniper1_DZC",10]];
...
// potential weapon list for leaders
SAR_band_leader_weapon_list = ["M1014","M16A2","Winchester1866","LeeEnfield"];
...
//potential weapon list for riflemen
SAR_band_rifleman_weapon_list = ["M16A2","Winchester1866","LeeEnfield","M1014"];
...
//potential weapon list for snipers
SAR_band_sniper_weapon_list = ["Huntingrifle"];
SAR_band_sniper_pistol_list = [];   

// potential item list for snipers
SAR_band_sniper_items = [["ItemSodaCoke",75],["FoodCanBakedBeans",60],["Sniper1_DZC",100]];
