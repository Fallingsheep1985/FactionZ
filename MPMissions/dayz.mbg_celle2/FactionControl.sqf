...
Faction4BaseProtection = true;
Faction5BaseProtection = true;
Faction6BaseProtection = true;
Faction7BaseProtection = true;
Faction8BaseProtection = true;
Faction9BaseProtection = true;
Faction10BaseProtection = true;

//Godmode at base
Faction1BaseGodmode = true;
Faction2BaseGodmode = true;
Faction3BaseGodmode = true;
Faction4BaseGodmode = true;
Faction5BaseGodmode = true;
Faction6BaseGodmode = true;
...
//////////////////////////////////////////////////////////////////////////
//WIN CHANCE
SlotsWinChanceRandom = random 100; //random number picked between 0 and 100
SlotsWinChance = 90; // random number must be higher than this to win
